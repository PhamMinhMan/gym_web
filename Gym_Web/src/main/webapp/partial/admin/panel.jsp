...
<html lang="en" class="perfect-scrollbar-on gr__demos_creative-tim_com">
<head>
	...
	<div class="sidebar" data-background-color="brown"
		...
		<div
			...
			<ul class="nav nav-parent">
				<li>
					<a href="dashboard.jsp"> <i class="ti-panel"></i>
						<p>Dashboard</p>
					</a>
				</li>
				<!-- <li>
				...
				<li><a href="SongOnlineAdmin.jsp"> <i class="material-icons">&#xe310;</i>
						<p>Song Online</p>
				</a></li>
